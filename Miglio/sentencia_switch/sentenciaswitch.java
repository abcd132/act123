...
public class sentenciaswitch {
		...
		/* Switch determina a partir de que "case" (opcion) comienza a 
			ejecutar. Esa opcion debe ser ENTERA (int), o bien un caracter
			entre apostrofes ('a','b','c',etc.) */
			
			/* ESTRUCTURA DEL SWITCH:
			 switch (condicin a analizar) {
